...
csv_file = r'DUALEM-orignal.csv' #this file is coming from the combined dualem and gps data 
json_file = r'dualem-output.json' #creates if json file is not present
